...
// var myContact = (arr1, arr2) => arr1.mycontact(arr2);
...
// };
// const squaredIntegers = sqaureList(realNumberArray);
...
//     const increment= (function() {
// return function increment(x, y, z){
// const args = [x, y, z];
...
// console.log(createPerson("Mariam", 56, "Female"));
...
// ude syntax using class keyword
...
//  document.querySelector('#message') = myColor();
